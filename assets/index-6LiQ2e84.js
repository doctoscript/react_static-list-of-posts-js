...
aut aut aut maxime quia temporibus ut omnis`}],Pc=[{id:1,name:"Leanne Graham",username:"Bret",email:"Sincere@april.biz"},{id:2,name:"Ervin Howell",username:"Antonette",email:"Shanna@melissa.tv"},{id:3,name:"Clementine Bauch",username:"Samantha",email:"Nathan@yesenia.net"},{id:4,name:"Patricia Lebsack",username:"Karianne",email:"Julianne.OConner@kory.org"},{id:5,name:"Chelsey Dietrich",username:"Kamren",email:"Lucio_Hettinger@annie.ca"},{id:6,name:"Mrs. Dennis Schulist",username:"Leopoldo_Corkery",email:"Karley_Dach@jasper.info"},{id:7,name:"Kurtis Weissnat",username:"Elwyn.Skiles",email:"Telly.Hoeger@billy.biz"},{id:8,name:"Nicholas Runolfsdottir V",username:"Maxime_Nienow",email:"Sherwood@rosamond.me"},{id:9,name:"Glenna Reichert",username:"Delphine",email:"Chaim_McDermott@dana.io"},{id:10,name:"Clementina DuBuque",username:"Moriah.Stanton",email:"Rey.Padberg@karina.biz"}],Lc=({user:e})=>e?B.jsx("a",{className:"UserInfo",href:`mailto:${e.email}`,children:e.name}):null,Tc=({comment:e={}})=>B.jsxs("div",{className:"CommentInfo",children:[B.jsxs("div",{className:"CommentInfo__title",children:[B.jsx("strong",{className:"CommentInfo__name",children:e.name})," by ",B.jsx("a",{className:"CommentInfo__email",href:`mailto:${e.email}`,children:e.email})]}),B.jsx("div",{className:"CommentInfo__body",children:e.body})]}),Mc=({comments:e})=>e.length>0?B.jsx("div",{className:"CommentList",children:e.map(i=>B.jsx(Tc,{comment:i},i.id))}):B.jsx("b",{"data-cy":"NoCommentsMessage",children:"No comments yet"}),Rc=({post:e})=>B.jsxs("div",{className:"PostInfo",children:[B.jsxs("div",{className:"PostInfo__header",children:[B.jsx("h3",{className:"PostInfo__title",children:e.title}),B.jsxs("p",{className:"PostInfo__author",children:[" Posted by ",B.jsx(Lc,{user:e.user})]})]}),B.jsx("p",{className:"PostInfo__body",children:e.body}),B.jsx(Mc,{comments:e.comments})]}),Dc=({posts:e})=>B.jsx("div",{className:"PostList",children:e.map(t=>B.jsx(Rc,{post:t},t.id))});function tm(e){return Pc.find(t=>t.id===e)??null}const jc=Nc.map(e=>({...e,user:tm(e.userId)})),Oc=zc.map(e=>({...e,user:tm(e.userId),comments:jc.filter(t=>t.postId===e.id)})),Fc=()=>B.jsxs("section",{className:"App",children:[B.jsx("h1",{className:"App__title",children:"Static list of posts"}),B.jsx(Dc,{posts:Oc})]});em(document.getElementById("root")).render(B.jsx(Fc,{}));
